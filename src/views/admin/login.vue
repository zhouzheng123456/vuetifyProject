    ...
    <v-content class="accent">
      <v-container fill-height fluid>
        <v-layout align-center justify-center>
          <v-form>
            <v-card max-width="100%" color="transparent" width="320" align-self-center flat dark>
              <v-text-field label="账号" v-model="account" :error-messages="accountErrors" filled></v-text-field>
              <v-text-field
              ...
              <v-card-actions class="px-0">
                <v-btn color="secondary" depressed block large :loading="loading" @click="submit">登录</v-btn>
              </v-card-actions>
            </v-card>
          </v-form>
        </v-layout>
